<x-app-layout>
    ...
    <div class="container mx-auto p-8">
        <h1 class="text-3xl font-bold text-center mb-6">Create Your Bid</h1>

        @if (Auth::check())
            <form action="{{ route('bids.store') }}" method="POST" class="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach ($products as $product)
                            <option value="{{ $product->id }}" data-price="{{ $product->min_price }}">{{ $product->name }}</option>
                        @endforeach
                ...
                <div>
                    <label for="special_instructions" class="block text-sm font-medium text-gray-700 mb-1">Special Delivery Instructions (Optional)</label>
                    <textarea
                ...
                <!-- Price -->
                <div>
                    <label for="price" class="block text-sm font-medium text-gray-700 mb-1">Price Willing to Pay</label>
                    <input
                        type="number"
                        id="price"
                        name="price"
        ...
        @else
            <div class="text-center">
                <p class="text-lg text-red-500">You must be signed in to create a bid. Please <a href="{{ route('login') }}" class="text-blue-500">log in</a> or <a href="{{ route('register') }}" class="text-blue-500">register</a>.</p>
            </div>
        @endif
    </div>
